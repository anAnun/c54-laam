...
namespace c54_laam.Services
{
    public class VisaAPIClient
    {
        ...
        public string DoMutualAuthCall(string path, string method, string testInfo, string requestBodyString, Dictionary<string, string> headers = null)
        {
            ...
            string userId = "X5AOBT3M8RBFZCKUQ1CA21oQ0vU6bt463COe2MelkQZMS-jkk";
            string password = "2SKW16SbY21icvP9z19CXvI4YNx0qkoWp8G";
            string certificatePath = @"C:\SF.Code\hackathon\c54-laam\reactgm\cert.p12";
